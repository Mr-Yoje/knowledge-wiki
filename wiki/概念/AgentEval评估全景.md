...
- **定位**：面向 Agent 的评测框架，提供 5 个核心决策层指标
- **核心指标**：TaskCompletion / ToolCorrectness / ArgumentCorrectness / PlanQuality / PlanAdherence / StepEfficiency
- **特点**：@observe 装饰器自动采集执行轨迹；与 LangSmith/Arize 可集成
- **成本控制**：内置 LLM-as-Judge 支持 gpt-4o-mini 做 judge
- **适用**：从开发调试到 CI/CD 到生产监控的全链路
...
- warm3snow《Agent Eval 最佳实践：从 Benchmark 到生产监控的完整落地指南》— https://www.cnblogs.com/informatics/p/20294772

## 相关页面

- [[Knowledge/wiki/资料/AgentEval最佳实践|Agent Eval 最佳实践指南]] — 从 Benchmark 到生产监控的完整落地
